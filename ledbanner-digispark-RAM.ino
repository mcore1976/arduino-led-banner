...
//
// The initial version - takes characters from USB and stores into RAM buffer
// Uploaded text here can be only 80 characters long due to RAM shortage 
// because of DigiCDC library taking huge portion of memory (but in turn 
...
// you will have to extended lines with zeroes if you have more than 6 LED modules
...
void setup() { 
     ...
     SerialUSB.begin();
     // copy initial text to display
     memcpy(sentence, "    THIS IS JUST A LED BANNER TEST USING ARDUINO DIGISPARK (C) Adam Loboda '2021", 80 );
